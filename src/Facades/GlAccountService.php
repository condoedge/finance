 ...
 * 
 * @method static \Condoedge\Finance\Models\Account createAccount(array $attributes)
 * @method static bool validateAccountId(string $accountId, int $teamId)
 * @method static \Condoedge\Finance\Casts\SafeDecimal getAccountBalance(\Condoedge\Finance\Models\Account $account, \Carbon\Carbon|null $startDate = null, \Carbon\Carbon|null $endDate = null, bool $includeUnposted = false)
 ...
 * @method static bool canAcceptManualEntries(\Condoedge\Finance\Models\Account $account)
 ...
 * @method static \Condoedge\Finance\Models\Account archiveAccount(\Condoedge\Finance\Models\Account $account, string $reason)
 * @method static bool mergeAccounts(\Condoedge\Finance\Models\Account $fromAccount, \Condoedge\Finance\Models\Account $toAccount, string $reason)
 * @method static array getAccountUsageStats(\Condoedge\Finance\Models\Account $account, \Carbon\Carbon|null $startDate = null, \Carbon\Carbon|null $endDate = null)
 * 
