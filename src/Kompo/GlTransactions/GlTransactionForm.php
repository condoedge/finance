...
class GlTransactionForm extends Form
{
    ...
    public function render()
    {
        return _Rows(
            ...
            _Card(
                ...
                )->id('transaction-lines-panel'),
                
                !$this->isViewOnly ? 
                    _Button(__('finance-add-line'))
                        ->icon('plus')
                        ->outlined()
                        ->class('mt-2')
                        ->selfGet('addTransactionLine')->inPanel('transaction-lines-panel') : null,
            ),
    ...
    {
        return _Columns(
            _SearchSelect(__('finance-account'))
                ->name("lines[{$index}][account_id]")
                ->optionsFrom('api.finance.accounts.search')
    ...
    public function addTransactionLine()
    {
        ...
        return _Rows(
            $currentLines->map(fn($line, $index) => 
