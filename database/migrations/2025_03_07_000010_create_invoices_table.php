...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('fin_invoices', function (Blueprint $table) {
            ...
            $table->decimal('invoice_total_amount', 19, config('kompo-finance.payment-related-decimal-scale'))->nullable()->storedAs('invoice_tax_amount + invoice_amount_before_taxes, 0');
