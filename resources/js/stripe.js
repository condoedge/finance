...
function activateStripe() {
    ...
    setTimeout(() => {
        try {
            ...
            cardElement._component.appendChild(cardPlaceholder);
            ...
            cardButton.addEventListener("click", async (e) => {
                ...
                if (error) {
                    ...
                    $("#stripe_payment_method_id").val(paymentMethod.id);
                    document
                        .querySelector("#stripe_payment_method_id")
                    ...
                    duplicateBtn.parentNode.replaceChild(originalBtn, duplicateBtn);
